...
import { listarCategoriasPaginacion, type Categoria } from "../../../../core/services/categoria.service";
...
const BarraInferior = () => {
  ...
  useEffect(() => {
    listarCategoriasPaginacion(1, 5).then(setCategorias);
  }, []);
        ...
        <div>
          ...
          <ul>
            {categorias.map((cat) => (
              <li
                key={cat.ctgraid}
                onClick={() => handleCategoriaClick(cat.ctgraimgnombre)}
